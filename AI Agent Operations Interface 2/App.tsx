...
export default function App() {
  ...
  return (
    <div className="h-screen flex bg-grok-surface">
      {/* Sidebar */}
      <div className="transition-grok-transform">
        <Sidebar
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Header with Grok styling */}
        <header className="border-b border-grok bg-background/80 glass-grok shadow-grok-sm">
          <div className="px-6 h-16 flex items-center justify-between">
            <div className="flex items-center gap-8">
              {/* Operations Agent Logo & Title */}
              <div className="flex items-center gap-4 animate-fade-in">
                <div className="flex items-center justify-center w-10 h-10 bg-primary rounded-grok-lg shadow-grok-sm hover-lift-subtle transition-grok">
                  <Bot className="h-5 w-5 text-primary-foreground" />
                </div>
                <div>
                  <h1 className="text-lg font-semibold text-grok-primary">Operations Agent</h1>
                  <div className="flex items-center gap-2 mt-1">
                    <Badge variant="secondary" className="bg-green-1 text-green-8 text-xs">
                      <div className="w-1.5 h-1.5 bg-green-6 rounded-full mr-1.5"></div>
                      Active
                    </Badge>
                    <Badge variant="outline" className="text-xs">Premium AI</Badge>
                  </div>
                </div>
              </div>
        ...
        {/* Content */}
        <main className="flex-1 overflow-hidden bg-grok-surface">
          <Tabs value={activeTab} onValueChange={setActiveTab}>
      ...
      {activeTab === 'chat' && (
        <div 
          className="fixed bottom-0 bg-background/95 glass-grok border-t border-grok z-40 shadow-grok-lg"
          style={{
        ...
        >
          <div className="p-6">
            ...
            <form onSubmit={(e) => {
              ...
              <div className="grok-elevated">
                <div className="flex items-end gap-3 p-4">
                  <textarea
                    name="message"
                    placeholder="Message Operations Agent..."
                    className="flex-1 resize-none bg-transparent text-sm placeholder:text-muted-foreground focus:outline-none min-h-[24px] max-h-32 leading-6 transition-grok px-0 py-3"
                    rows={1}
                    onKeyDown={(e) => {
              ...
              <p className="text-xs text-grok-secondary text-center mt-3">
